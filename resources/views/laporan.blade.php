            ...
            <div id="content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.print') }}" method="GET" target="_blank">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="range_tanggal" name="range_tanggal"
                ...
                <script>
                    function showDetails(transactionId) {
                        $.get(`/admin/laporan/api/transaction/${transactionId}`, function(data) {
                            let rows = '';
                ...
                <tr>
                    ...
                    <td>Rp ${detail.qty * detail.harga}</td>
                            ...
                            $('#print-btn').attr('href', `laporan/report/cetak/${transactionId}`);
